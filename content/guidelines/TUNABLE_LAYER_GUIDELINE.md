...
- last_checked: 2026-02-08
<!-- content -->
The three tunable layers map to specific points in the existing Unified Nexus pipeline. The diagram below shows where each intervention sits relative to the components defined in `UNIFIED_NEXUS_ARCHITECTURE.md`.
